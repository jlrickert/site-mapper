	...
	Convey("Given a valid sitemap", t, func() {
		Convey("should be able translate to DOT format", func() {
			...
			lines := []string{
				...
				`"https://github.com/user1" -> "https://github.com/project4";`,
				`"https://github.com/user1" -> "https://github.com/user1/project1";`,
				`"https://github.com/user1" -> "https://github.com/user1/project2";`,
				`"https://github.com/user2" -> "https://github.com/project2";`,
				`"https://github.com/user2" -> "https://github.com/project3";`,
				`"https://github.com/user2" -> "https://github.com/project1";`,
